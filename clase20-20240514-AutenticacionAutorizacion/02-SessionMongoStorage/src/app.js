...
app.use(sessions({
    ...
    store: MongoStore.create({
        ttl: 3600,
        mongoUrl: "mongodb+srv://backend53140:CoderCoder@cluster0.5cr4g2l.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
        dbName:"clase20prueba",
        collectionName:"pruebaSessions"
    })
}))
