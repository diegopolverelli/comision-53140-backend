...
export class CustomRouter{
    ...
    get(ruta, permisos, ...funciones){  // los ... son aquí el operador rest
        ...
        this.router.get(ruta, this.respuestasPersonalizadas, this.accesos(permisos), ...this.manejaFunciones(funciones)) // los ... son aquí el operador spread

    }

    post(ruta, permisos, ...funciones){  // los ... son aquí el operador rest
        this.router.post(ruta, this.respuestasPersonalizadas, this.accesos(permisos), ...this.manejaFunciones(funciones)) // los ... son aquí el operador spread
    }
