...
app.get('/usuario', passportCall("jwt"), auth(["user", "admin"]), (req, res) => {
...
//         if (!user) { return res.redirect('/signin') } // desde passport.config devuelvo return done(null, false)
//         res.redirect('/account'); // desde passport.config devuelvo return done(null, usuario)
//     })(req, res, next);
// });
